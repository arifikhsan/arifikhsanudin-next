  ...
  return (
    <DefaultLayout>
      <div className='py-16 font-display md:pt-32 md:pb-36 md:text-center'>
        ...
        <a target='_blank' href='/' className='inline-block px-4 py-2 mt-4 font-semibold text-white transition duration-500 bg-gradient-to-r from-emerald-500 to-green-500 hover:font-bold'>View Curriculum Vitae</a>
      </div>
    </DefaultLayout>
  );
}
